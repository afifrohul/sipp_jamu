...
<div>
    ...
    <div class="alert alert-default mb-5 flex justify-between">
        <div class="flex gap-2 items-center">
            ...
            <p class="text-base"><strong>Halo, {{ Auth::user()->name }}.</strong> Terdapat {{ $getCountTransactionAccept }} pesanan yang diterima. <a class="font-bold hover:opacity-75 transition-all duration-300" href="{{ url('/back-farmer/transaction') }}">Klik disini untuk melakukan transaksi.</a> </p>
        </div>
