...
<div>
    <div class="card mb-8">
        ...
        <div class="card-body">
            <form method="POST" action="{{url('/back-seller/transaction/update',$getDetailTransaction->id)}}" enctype="multipart/form-data" novalidate>
                @method('PUT')
                @csrf
                <div>
            ...
            <button class="btn-shadow-cancel mt-2"><a href="{{ url('/back-seller/transaction') }}"> Batal</a></button>
        </div>
    </div>
</div>
<script>
