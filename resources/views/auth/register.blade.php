                    ...
                    <div class="py-4 px-6 space-y-2 md:space-y-2">
                        ...
                        <form class="space-y-2 md:space-y-2" method="POST" action="{{ route('register') }}" novalidate  >
                            ...
                            <div class="">
                                ...
                                <x-input id="no_hp" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" type="text" name="no_hp" :value="old('no_hp')" required autofocus placeholder="0812398xxxxx" />
                            </div>
